export const reportMeta: Record<string, { title: string; source: string; tabs: string[]; description: string }> = {
  ...
  retributions: { title: 'Laporan Retribusi', source: 'e-Retribusi', tabs: ['Monitoring', 'Rekap OPD'], description: 'Monitoring target dan realisasi retribusi berdasarkan OPD pengelola.' },
