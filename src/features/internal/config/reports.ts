export const reportMeta: Record<string, { title: string; source: string; tabs: string[]; description: string }> = {
  pbb: { title: 'Laporan PBB-P2', source: 'e-PBB', tabs: ['Ketetapan', 'Realisasi', 'Piutang'], description: 'Monitoring ketetapan, penerimaan, dan piutang Pajak Bumi dan Bangunan.' },
  bphtb: { title: 'Laporan BPHTB', source: 'e-BPHTB', tabs: ['Ketetapan', 'Realisasi'], description: 'Rekap transaksi dan realisasi Bea Perolehan Hak atas Tanah dan Bangunan.' },
